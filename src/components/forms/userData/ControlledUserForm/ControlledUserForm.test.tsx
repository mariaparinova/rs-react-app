...
import { ControlledUserForm } from './ControlledUserForm.tsx';
import {
...
describe('<ControlledUserForm>', () => {
  test('has all required fields', () => {
    // ACT
    render(<ControlledUserForm submitHandler={() => {}} initFormData={undefined} />);
  ...
  describe('validation errors', () => {
    ...
    describe('field "gender"', () => {
      test('must be specified', async () => {
        // ACT
        render(<ControlledUserForm submitHandler={() => {}} initFormData={undefined} />);
        const input = screen.getByLabelText(/gender/i);
    ...
    describe('field "terms and conditions"', () => {
      test('must be specified', async () => {
        // ACT
        render(<ControlledUserForm submitHandler={() => {}} initFormData={undefined} />);
        const input = screen.getByLabelText(/terms and conditions/i);
        await userEvent.click(input);
        await userEvent.click(input);
  ...
  test('calls onSubmit callback', async () => {
    ...
    // ACT
    render(<ControlledUserForm submitHandler={handleSubmit} initFormData={initFormData} />);
